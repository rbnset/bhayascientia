...
'title' => 'Akses Gratis',
'description' => 'Baca dan unduh semua publikasi tanpa biaya atau batas.',
'features' => [
'Unduh PDF naskah lengkap secara langsung.',
'Lihat semua publikasi terbuka tanpa login.',
'Gratis selamanya, tanpa paywall atau hidden fee.',
'Dukungan mobile-responsive untuk baca di mana saja',
],
'image' => 'assets/images/thumbnails/overview.png',
'ctaText' => 'Cari Publikasi',
'ctaHref' => '#',
],
[
'step' => 'Fitur 2',
...
'description' => 'Kelola koleksi pribadi dengan mudah dan pintar.',
'features' => [
'Tambah ke favorites untuk akses cepat.',
'History baca otomatis untuk lanjutkan membaca.',
'Tambah daftar "akan dibaca" dengan reminder.',
'Sinkronisasi antar device via akun gratis.',
],
'image' => 'assets/images/thumbnails/image.png',
'ctaText' => 'Menu Library',
'ctaHref' => '#',
],
[
'step' => 'Fitur 3',
