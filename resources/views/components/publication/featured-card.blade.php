...
<a href="{{ $detailUrl }}"
    ...
    {{-- Background Image --}}
    <img src="{{ $coverUrl }}"
        class="absolute inset-0 object-cover w-full h-full transition-transform duration-500 thumbnail group-hover:scale-110"
        alt="Cover {{ $title }}" loading="eager" onload="console.log('✅ Image loaded:', this.src)"
        onerror="console.error('❌ Image failed:', this.src); this.onerror=null; this.src='https://placehold.co/800x600/FF6B18/white?text=Cover';" />
