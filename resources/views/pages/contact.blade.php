...
<section class="px-4 sm:px-6 lg:px-8 mx-auto max-w-[1130px] mt-8 sm:mt-10 md:mt-12 mb-12 sm:mb-16">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3 sm:gap-8">
        ...
        {{-- Left: Quick Topics & Security Notice --}}
        <div class="space-y-4 lg:col-span-1 sm:space-y-6">
            ...
            <div
                ...
                <div class="flex items-center gap-3">
                    <a href="#"
                        class="w-11 h-11 sm:w-12 sm:h-12 bg-white rounded-xl flex items-center justify-center hover:bg-[#FF6B18] hover:text-white transition-all shadow-sm">
            ...
            {{-- Security Notice --}}
            <div
                class="bg-gradient-to-br from-[#FFF7F2] to-[#F8F9FC] rounded-xl sm:rounded-2xl border-2 border-[#FFE2D2] p-4 sm:p-5">
                <div class="flex items-start gap-3">
                    <div class="w-8 h-8 bg-[#FF6B18]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                        <p class="text-xs sm:text-sm font-bold text-[#1A1A1A] mb-1">🔒 Catatan Keamanan</p>
                        <p class="text-[10px] sm:text-xs leading-relaxed text-[#737373]">
                            Jangan kirim password, OTP, atau data sensitif melalui form ini.
                        </p>
                    </div>
                </div>
            </div>
...
<script>
    ...
    window.openMapModal = function() {
        ...
        if (modal && content && iframe) {
            // Set iframe src when opening (lazy load)
