    ...
    public static function configure(Table $table): Table
    {
        return $table
            ->columns([
                ...
                // ── Cover publikasi ──
                // ✅ Support opini — fallback ke publication langsung jika version null
                ...
                // ── Versi publikasi ──
                // ✅ Support opini — tampilkan judul publikasi + label "Opini" atau "v{n}"
                ...
                // ✅ Support opini — baca status dari publication langsung jika version null
            ...
            ->modifyQueryUsing(fn($query) => $query->with([
                ...
                'notes',
                'reviewer',
                // ✅ Eager load KEDUANYA — via version (non-opini) dan langsung (opini)
            ...
            ->filters([
                ...
                SelectFilter::make('publication_status')
                    ...
                    ->query(function (Builder $query, array $data): Builder {
                        ...
                        // ✅ Filter status untuk kedua tipe (dengan & tanpa versi)
            ...
            ->recordActions([
                ViewAction::make('preview')
                    ...
                    ->modalHeading(function ($record) {
                        // ✅ Support opini — label versi fleksibel
                ...
                Action::make('download_revision')
                    ...
                    ->action(function ($record) {
                        ...
                        // ✅ Support opini — label filename fleksibel
                        $versionLabel = is_null($record->publication_version_id)
                            ? 'opini'
